...
export default function Login() {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      // ✅ Use api instance (handles base URL) instead of raw fetch
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-[#140021] to-[#000000] text-white flex flex-col">
      <header className="w-full px-6 py-5 flex items-center justify-between max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-5">
          ...
          <Link to="/register" className="text-white/80 hover:text-white text-sm font-medium transition">
            Register
          </Link>
        </div>
      </header>
        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col items-center gap-8">
            <div className="text-center">
              ...
              <p className="text-purple-400 mt-1">Log in to your account to continue</p>
            </div>
            ...
            <form onSubmit={onSubmit} noValidate className="w-full flex flex-col gap-4">
              ...
              {/* ✅ Google Login with proper handler */}
              <GoogleLogin
